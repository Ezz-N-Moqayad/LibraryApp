...
class FCMService : FirebaseMessagingService() {
    ...
    companion object {
        ...
        fun sendRemoteNotification(title: String, body: String) {
            ...
            val at = object : AsyncTask<Void, Void, String>() {
...
//                        json.put("to", "dqJosCIqQLW0F-h9dZ7S8b:APA91bHg4rkQ41x4Bm9U7Hfyfuf8U4rVk0oV02848kezdJz-OtD7V-oRb0L2QRVix_5vyrTya6gqeZ3rxY3ePcmGYzX_wqp2ZEh3rEgYTeYuswIvjB8I3FpHuGE7FIZZgZ5IVVdsKmpF")
                        ...
                        val request = Request.Builder()
                            .header(
                                "Authorization",
                                "key=AAAADgWfWGU:APA91bEFpuliC9PdJ3i1FyW4DwYb6EbcX8Jcz3Cw1EIneg0k1AehHdZ_v9PcseMo8X53cM2Kz8PDiSwQpg9fbvvIYQ1Bf--quL1BNU3TNL0b5LBGLS6YkwQheVvxUFEWKqtzLdkF_bLs"
                            )
